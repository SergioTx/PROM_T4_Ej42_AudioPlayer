package com.example.sergio.audioplayer;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mediaPlayer = MediaPlayer.create(this, R.raw.jokerandthethief);
        finalTime = mediaPlayer.getDuration(); //faltaba
        seekBar = (SeekBar) findViewById(R.id.seekBar);
        songName.setText("Joker & the Thief.mp3");
